...
/**
 *
 * @param {object} oBase parsed css base
 * @param {object} oCompare parsed css compare
 * @returns {{stack: ({stylesheet: {rules: []}, type: string}|*), diff: ({stylesheet: {rules: []}, type: string}|*)}}
 */
